...
const AdminPage = async () => {
  ...
  return (
    <>
            <div className="">
              <h2 className='mt-8 mb-6 font-bold text-[22px]'>Welcome <span className='text-blue-400 text-[20px] font-semibold'>{session?.user.name || session.user.username}</span> </h2>
            </div>
