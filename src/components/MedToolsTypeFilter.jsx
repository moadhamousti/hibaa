...
// const MedToolsTypeFilter = ({ onChange }) => {
//   const [categories, setCategories] = useState([]);
...
//   return (
//     <div className="relative">
//       <select onChange={onChange} className="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline h-10 overflow-y-auto">
//         {categories.map((category) => (
//           <option key={category.id} value={category.id}>{category.title}</option>
//         ))}
//       </select>
