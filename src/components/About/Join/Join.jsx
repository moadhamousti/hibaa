  ...
  return (
    <div className='bg-[--softTextColor]  w-full text-center '>
        <div className='w-1/2  mx-auto'>
            ...
            <h1 className='text-[#EF507F] text-3xl font-semibold py-4  '>Rejoignez-nous pour faire la différence.</h1>
            <p className=' text-[--bg] text-2xl  p-4 text-center '>Ensemble, nous pouvons faire la différence. Rejoignez-nous pour partager des équipements, soutenir les communautés et créer un avenir meilleur pour tous.</p>
