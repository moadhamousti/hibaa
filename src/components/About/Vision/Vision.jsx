...
/>
      ...
      <div className='sm:w-1/2 text-[--bg] lg:w-2/3  flex flex-col sm:text-left text-center items-start justify-center h-full  sm:pr-2 md:pr-3 lg:pr-5  min-h-9'>
        <h1 className='font-bold py-4 capitalize text-xl sm:text-xl md:text-3xl text-cente lg:text-5xl'>Notre vision</h1>
        <p className=' sm:inline-block mt-4 md:text-lg lg:text-xl  sm:text-left text-center'>
        Nous envisageons un monde où chaque individu a accès aux équipements et aux ressources dont il a besoin pour s'épanouir. Notre vision promeut l'inclusivité, l'égalité et la durabilité, en réaffectant les équipements excédentaires pour répondre aux besoins urgents. </p>
      </div>
    </div>
  )
}
