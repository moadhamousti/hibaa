...
<div 
      ...
      <div className='w-full text-[--bg] lg:w-full p-6 sm:p-8 md:p-12 lg:p-16 flex flex-col items-start justify-center z-10 min-h-9'>
            ...
            <p className=' sm:inline-block mt-4 md:text-lg lg:text-xl font-in'>
              Nous sommes <span className='font-extrabold '> Heba&rsquo;Ataa</span>, Rejoignez-nous dans notre mission visant à rendre les soins de santé accessibles à tous.
            </p>
                <div className='mt-8'>
                  <Button
                      href="/feed"
